...
class vglWooProductSlider extends WPBakeryShortCode
{
	...
	public function vc_html_func( $atts, $content ) {
		...
		<woo-product-slider :products='<?php echo htmlspecialchars(json_encode($data), ENT_QUOTES, 'UTF-8'); ?>' :product-count='<?php echo $product_count ?>' desktop-slide-count='<?php echo $desktop_slide_count ?>' mobile-slide-count='<?php echo $mobile_slide_count ?>' class="<?php echo $css_class; ?>"></woo-product-slider>
